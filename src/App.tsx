...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      {showCart && <Cart count={cartCount} onClose={() => setShowCart(false)} onAdd={addToCart} />}
