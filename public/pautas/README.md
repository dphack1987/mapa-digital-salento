# Pautantes del proyecto

Esta carpeta guarda la información visual y documental de cada negocio o atractivo que se quiere incluir en el mapa turístico.

Estructura recomendada por pautante:

- pautas/<nombre_pautante>/
  - <nombre_pautante>.md
  - informacion_<nombre>.txt
  - imagenes/
    - imagen_1.jpg
    - imagen_2.png
    - ...

Ejemplos de pautantes activos:
